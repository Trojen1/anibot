...
💚Airings,
💙Schedules,
💜Watch Orders of Animes, etc also
...
[❌](https://images3.alphacoders.com/101/1016459.jpg)"""
        )
    else:
...
async def feed_(client: anibot, message: Message, mdata: dict):
    ...
    await client.send_message(mdata['chat']['id'], f"For issues or queries please contact @tr0j3n")
